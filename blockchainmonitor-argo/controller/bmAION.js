...
const abi = require("../config/abiAION");

let AIONCONTRACTADDRESS = process.env.AIONCONTRACTADDRESS;
...
const contract = new web3.eth.Contract(abi, AIONCONTRACTADDRESS, error => {
  console.log(error);
});
    ...
    web3.eth.getTransactionReceipt(event.transactionHash, function(
      ...
      if (err || result == null) {
        ...
        let record = {
          ...
          value: Number(event.returnValues.value / Math.pow(10, 8)).toFixed(8),
          coin: "AION",
          userId: userId,
