...
const abi = require("../config/abiDGD");

let DGDCONTRACTADDRESS = process.env.DGDCONTRACTADDRESS;
...
const contract = new web3.eth.Contract(abi, DGDCONTRACTADDRESS, error => {
  console.log(error);
});
    ...
    web3.eth.getTransactionReceipt(event.transactionHash, function(
      ...
      if (err || result == null) {
        ...
        let record = {
          ...
          value: Number(event.returnValues._value / Math.pow(10, 9)).toFixed(8),
          coin: "DGD",
          userId: userId,
