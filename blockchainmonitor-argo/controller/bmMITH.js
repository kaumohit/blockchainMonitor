...
const abi = require("../config/abiMITH");

let MITHCONTRACTADDRESS = process.env.MITHCONTRACTADDRESS;
...
const contract = new web3.eth.Contract(abi, MITHCONTRACTADDRESS, error => {
  console.log(error);
});
    ...
    web3.eth.getTransactionReceipt(event.transactionHash, function(
      ...
      if (err || result == null) {
        ...
        let record = {
          ...
          value: Number(event.returnValues._value / Math.pow(10, 2)).toFixed(8),
          coin: "MITH",
          userId: userId,
