...
const abi = require("../config/abiLOOM");

let LOOMCONTRACTADDRESS = process.env.LOOMCONTRACTADDRESS;
...
const contract = new web3.eth.Contract(abi, LOOMCONTRACTADDRESS, error => {
  console.log(error);
});
