...
const abi = require("../config/abiNPXS");

let NPXSCONTRACTADDRESS = process.env.NPXSCONTRACTADDRESS;
...
const contract = new web3.eth.Contract(abi, NPXSCONTRACTADDRESS, error => {
  console.log(error);
});
