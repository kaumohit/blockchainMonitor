...
const abi = require("../config/abiZIL");

let ZILCONTRACTADDRESS = process.env.ZILCONTRACTADDRESS;
...
const contract = new web3.eth.Contract(abi, ZILCONTRACTADDRESS, error => {
  console.log(error);
});
    ...
    web3.eth.getTransactionReceipt(event.transactionHash, function(
      ...
      if (err || result == null) {
        ...
        let record = {
          ...
          value: Number(event.returnValues.value / Math.pow(10, 12)).toFixed(8),
          coin: "ZIL",
          userId: userId,
