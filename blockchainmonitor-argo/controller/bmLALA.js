...
const abi = require("../config/abiLALA");

let LALACONTRACTADDRESS = process.env.LALACONTRACTADDRESS;
...
const contract = new web3.eth.Contract(abi, LALACONTRACTADDRESS, error => {
  console.log(error);
});
