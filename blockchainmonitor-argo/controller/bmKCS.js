...
const abi = require("../config/abiKCS");

let KCSCONTRACTADDRESS = process.env.KCSCONTRACTADDRESS;
...
const contract = new web3.eth.Contract(abi, KCSCONTRACTADDRESS, error => {
  console.log(error);
});
    ...
    web3.eth.getTransactionReceipt(event.transactionHash, function(
      ...
      if (err || result == null) {
        ...
        let record = {
          ...
          value: Number(event.returnValues.value / Math.pow(10, 6)).toFixed(8),
          coin: "KCS",
          userId: userId,
